...
export default class blog1 extends Component {
  ...
  render() {
    return (
      ...
      <div className='blog'>
        <article>
         <header><h1>Indirect Flights - Analysis</h1></header> 

          <p>
          For this analysis I have chosen the net/web artwork, Indirect Flights 2015 by <cite>Joe Hamilton 
          and J.G. Biberkopf</cite>. This artwork is supported by The Moving Museum and consists of 
          ...
          what is in view and what is hidden <cite>(Hamilton, 2015)</cite>. Joe Hamilton says that this work is an 
          attempt to represent a contemporary landscape, in a moment defined by the vast number of digital 
          technologies and the global transportation of bodies, commodities and goods <cite>(Hamilton, 2015)</cite>. 
          </p>
          <p>
          ...
          how artworks came to be, and how they will change <cite>(Danae, 2019: p 7)</cite> (along with the change of the 
          ...
          <cite>(Danae, 2019: pp 7-8)</cite>. This final remark was a bit unclear to me: I am unsure whether Danae 
          ...
          becoming more and more focused on the digital and the internet <cite>(Carrier, 2020)</cite>. When looking at 
