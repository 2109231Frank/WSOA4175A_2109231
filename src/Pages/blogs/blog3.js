    ...
    return (
      <div className='blog'>
         ...
         <header><h1>Internet, Society and Design Justice</h1></header>
          ...
          They explain a personal experience which was one of many experiences where Sasha has been 
          ...
          <ul>
              <li>Helps communities in their struggle against exploitative/oppressive systems.</li>
              <li>Focuses on the voices of the oppressed.</li>
              <li>Prioritizes the community</li>
              <li>Views change as something that comes from the design process instead of something that 
                  emerges as a product of a process.</li>
              <li>Sees everyone as an expert with regard to their own lived experiences (which gives everyone 
                  a unique contribution that they bring to the design process).</li>
              <li>Is open and shares processes and tools with the community.</li>
              <li>Works towards an outcome that is sustainable and is controlled by the community.</li>
              <li>Is non-exploitative.</li>
              <li>Looks at what is already working (traditional practices/knowledge) before looking at new 
                  design options.</li>
          </ul>
          <p>
          ...
          tradition, equality and oppressive systems that come from design processes and outcomes that 
          do not follow the design justice framework.
          </p>
          <p>
          With regard to internet and society I shall look at Spyros Kasapis’ article, Internet Access is a 
          Fundamental Right. Especially, Amidst a Pandemic. The article starts off strong stating that 
          happiness is a basic human right and everything that contributes to this is a basic human right as 
          ...
          follow the principles from the Design Justice Network in order to overcome design issues resulting 
          in oppression, exploitation, or unhappiness. I also agree with Spyros with regards to the importance 
